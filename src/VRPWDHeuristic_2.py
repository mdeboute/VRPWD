...
class VRPWDHeuristic_2:
    ...
    def second_stage(self, dpd_nodes_per_vehicle):
        ...
        for src_dest in pair_by_pair_truck_dpd_nodes:
            ...
            print(
                "dpd_nodes_per_vehicle[1][counter] : ",
                dpd_nodes_per_vehicle[1][counter],
            )
            print(
                "dpd_nodes_per_vehicle[2][counter] : ",
                dpd_nodes_per_vehicle[2][counter],
            )
            for current_truck_node in sp_truck:
                ...
                sp_d1 = self.instance.drone_time_matrix[current_truck_node - 1][
                    dpd_nodes_per_vehicle[1][counter] - 1
                ]
                sp_d2 = self.instance.drone_time_matrix[current_truck_node - 1][
                    dpd_nodes_per_vehicle[2][counter] - 1
                ]
                print("sp_d1 = ", sp_d1)
                print("sp_d2 = ", sp_d2)
                if sp_d1 < min_d1_tt:
